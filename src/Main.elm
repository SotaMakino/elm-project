...
view model =
    Html.div [ style "padding" "30px" ]
        ...
        , Html.div []
            ...
            , controllButton model.isStopped model.barList Stop model.prevState
            ]
...
controllButton : Bool -> List Int -> State -> State -> Html Msg
controllButton isStopped list state prevState =
    let
        nextOp : Msg
        nextOp =
        ...
        isDisabled : Bool
        isDisabled =
            prevState == Randomizing || List.sort list == list
